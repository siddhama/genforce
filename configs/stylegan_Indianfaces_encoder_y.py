...
gan_model_path = 'checkpoints/styleganinv_ffhq256_generator.pth'
...
data = dict(
    ...
    train=dict(root_dir='data/', data_format='list',
               image_list_path='data/IndianFaces/Indian_train_list.txt',
               resolution=resolution, mirror=0.5),
    val=dict(root_dir='data/', data_format='list',
             image_list_path='./data/IndianFaces/Indian_val_list.txt',
...
controllers = dict(
    ...
    Checkpointer=dict(every_n_iters=5000, first_iter=False),
)
